...
module Jekyll
  class EnglishMap < Generator
    ...
    def generate(site)
      ...
      names = {'시애틀'=>'Seattle', '시드니'=>'Sydney', '오클랜드 / 크라이스트처치'=>'Auckland / Christchurch', '후쿠오카 / 유후인'=>'Fukuoka / Yufuin', '도쿄 / 하네다'=>'Tokyo / Haneda', '삿포로 / 조잔케이 / 오타루'=>'Sapporo / Jozankei / Otaru', '싱가포르'=>'Singapore', '런던'=>'London'}
